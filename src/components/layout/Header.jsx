      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link to="/" className="text-white hover:text-indigo-200 transition-colors px-3 py-2 text-sm font-medium">
              Home
            </Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-indigo-700">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/" className="text-gray-900 !text-gray-900 hover:bg-indigo-500 block px-3 py-2 rounded-md text-base font-bold">
              Home
            </Link>
            <Link to="/about" className="text-gray-900 !text-gray-900 hover:bg-indigo-500 block px-3 py-2 rounded-md text-base font-bold">
              About
            </Link>
